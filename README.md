...
<table width="100%">
    ...
    <tbody>	
        <tr>
            <td width="10%" align="center">상병<br>김강년</td>
...
## 개발 과정
 ### 기초 설계
 * 먼저 기초적인 서비스 플로우와 파트별 흐름 구조도를 작성해 보았습니다.
<table width="100%">
    <thead>
        <tr>
			<th style="text-align:center" width="50%">
 ...
 * domain : Entity들이 모여있는 패키지입니다.
 ...
 ### Analysis
 #### 목적
  분석 파트의 아이디어의 시작은 ’장병들의 글들을 가지고 유의미한 데이터를 만들어 보는 것’이었습니다. 수많은 글 중에서 문제를 발견하고, 지휘관에게 알려줌으로서 실질적으로 문제 해결에 도움을 주는 것이 분석 파트의 목적입니다.

 #### 어떠한 분석을 할 것인가
  저희는 그렇다면 어떠한 분석을 하여 결과를 제공해주어야 유의미할 것일지에 대해 생각해보았습니다. 해커톤 기간 내에 개발할 수 있는 선에서, 유의미한 것을 생각해본 결과 장병들의 글이 가진 긍정, 부정 여부 분석, 지휘관이 설정한 키워드 탐색, 글에서 많이 나온 키워드 랭킹을 분석 기능으로서 선정하였습니다.

 #### DB에서 데이터 가져오기
  먼저 pymysql 라이브러리를 통해 DB와 연결하고 SQL문으로 데이터를 가져옵니다. 전자는 ConnectDB.py에서 후자는 SQL.py에서 확인할 수 있습니다. 이때 DB 접속정보는 github상에 올리지 않아야 하나 대회이기에 올려두었습니다. 
...
## 기대효과
 &nbsp;지금까지, 아직도 군인들은 제대로된 군인들만의 커뮤니티를 가지고 있지 않습니다. 자신이 겪고 있는 문제가 자신만의 문제인지, 우리 모두의 문제인지 알 수 없고 다른 이들과 소통하고 싶어도 제한되는 경우가 대다수입니다.<br/>  
국방신문고는 이러한 군인들에게 ’나만 그런것이 아니다. 나만 힘든 것이 아니었다.’를 알게 해 주고, 서로의 소통창구가 되어줄 것입니다. 국방신문고의 캐치프레이즈인 ’우리의 생각은 우리 모두에게 중요하니까’가 이를 반영하고 있습니다.<br/>  
또한 국방신문고는 자유로운 소통을 추구함과 동시에 장병들의 게시글, 댓글 데이터를 통해 문제를 파악히고 분석해냅니다. 단순 키워드 랭킹부터 지휘관만 열람 가능한 예하 장병들의 게시글, 댓글의 긍부정 정도 및 키워드 탐색을 지원합니다.<br/>  
지휘관은 예하 장병들이 가진 생각을 추측하고, 본인이 지정한 키워드를 작성한 장병이 있는지 알 수 있을 것입니다.

## 발전 가능성
&nbsp;국방신문고 시스템은 프론트, 웹서버, DB, 분석서버가 전부 분리된 채 서로 정보만 주고받는 형태로 유지보수, 기능 추가 등에 용이성을 가집니다.
소원수리(개인고충 및 부대발전에 대한 제언) 기능을 확장하여 지휘관이 예하 장병들에 대해 설문조사를 실시할 수 있고, 부대 공지사항 등을 국방신문고를 통해 전파할 수 있을 것입니다.<br/>  
또한 커뮤니티가 활성화 되었을 때, 분석 기능의 추가를 통해 수많은 정보를 얻어낼 수 있을 것으로 보여집니다. 특히 머신러닝을 추가적으로 활용한다면 장병들이 가진 공통적인 불만이나 고충을 손쉽게 파악할 수 있을 것입니다. 용사가 아니기에 쉽게 알 수 없는 용사들의 고충을 확인하고, 조치할 수 있을 것입니다.<br/>  
또한 현재 반응형 웹 시스템을 구현하지 못했는데, 반응형 웹을 구현함으로서 접근성을 높일 수 있을 것입니다.
마지막으로 국방신문고는 부대 정보가 보안상 탑재되지 못하여 특정 부대에 어떠한 지휘관과 장병들이 있는지에 대한 정보가 부재된 상태입니다. 추후 국방인사DB 접근 등을 통해 해당 데이터가 탑재될 시 본래 기능을 보다 완벽하게 가용할 수 있을 것입니다
